...
%
%
%          Project Name: NjustThesis Template for Bachelor of 
%
%
%------------------------------------------------------------------------------------------
%
...
\pagestyle{fancy}
\chead{\quad\\
\song\xiaoer\bfseries{
本\hspace{0.5mm}科\hspace{0.5mm}毕\hspace{0.5mm}业\hspace{0.5mm}设\hspace{0.5mm}计\hspace{0.5mm}说\hspace{0.5mm}明
\hspace{0.5mm}书}}
